...
#define AUTH_REQ_GSS		10	/* 7 GSSAPI without wrap() */
#define AUTH_REQ_GSS_CONT	11	/* 8 Continue GSS exchanges */
#define AUTH_REQ_SSPI		12	/* 9 SSPI negotiate without wrap() */
#define AUTH_REQ_DIGEST		13	/* sha256, scrypt or argon2 */
#define AUTH_REQ_IDP	    14	/* Redshift Native IDP Integration */

#define AUTH_DIGEST_SHA256 0
#define AUTH_DIGEST_SCRYPT 1
#define AUTH_DIGEST_ARGON2 2
