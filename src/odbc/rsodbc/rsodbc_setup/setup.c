...
#define DFLT_GROUP_FEDERATION "0"
#define DFLT_AUTO_CREATE "1"
...
{ RS_GROUP_FEDERATION , DFLT_GROUP_FEDERATION},
...
{ RS_GROUP_FEDERATION , RS_GROUP_FEDERATION },
...
static int rs_idp_controls[] =
{
	...
	IDC_IDC_REGION,
	IDC_ISSUER_URL_STATIC,
	IDC_ISSUER_URL,
	IDC_LISTEN_PORT_STATIC,
	IDC_LISTEN_PORT,
	IDC_IDP_RESPONSE_TIMEOUT_STATIC,
	...
	IDC_IDP_CID_STATIC,
	IDC_IDP_CID,
	IDC_IDP_REGION_STATIC,
	IDC_IDP_REGION,
	IDC_IDP_EPU_STATIC,
	IDC_IDP_EPU,
	IDC_IDP_WORKGROUP_STATIC,
	IDC_IDP_WORKGROUP,
	IDC_IDP_AKI_STATIC,
	IDC_IDP_AKI,
	IDC_IDP_SAK_STATIC,
...
static rs_dialog_controls rs_iam_val_controls[] =
{
	...
	{IDC_GROUP_FEDERATION, RS_CHECKBOX_CONTROL, RS_GROUP_FEDERATION },
...
{
	// Cluster info (new duplicate IDs)
	IDC_IDP_CID_STATIC,
	IDC_IDP_CID,
	IDC_IDP_WORKGROUP_STATIC,
	IDC_IDP_WORKGROUP,
	...
	IDC_IDP_EPU_STATIC,
	IDC_IDP_EPU,
	// Direct token flow fields
	IDC_TOKEN_STATIC,
	IDC_TOKEN,
	IDC_TOKEN_TYPE_STATIC,
	IDC_TOKEN_TYPE,
	// Identity-enhanced credentials flow fields (new duplicate IDs)
	IDC_IDP_AKI_STATIC,
	IDC_IDP_AKI,
	IDC_IDP_SAK_STATIC,
	IDC_IDP_SAK,
...
static rs_dialog_controls rs_idp_token_auth_val_controls[] =
{
	...
	// Identity-enhanced credentials flow (new duplicate IDs, same RS_* params)
	{ IDC_IDP_AKI, RS_TEXT_CONTROL, RS_ACCESS_KEY_ID },
	{ IDC_IDP_SAK, RS_TEXT_CONTROL, RS_SECRET_ACCESS_KEY },
	{ IDC_IDP_ST, RS_TEXT_CONTROL, RS_SESSION_TOKEN },
	// Cluster info (new duplicate IDs, same RS_* params)
	{ IDC_IDP_CID, RS_TEXT_CONTROL, RS_CLUSTER_ID },
	{ IDC_IDP_REGION, RS_TEXT_CONTROL, RS_REGION },
	{ IDC_IDP_EPU, RS_TEXT_CONTROL, RS_END_POINT_URL },
	// Common fields
	{ IDC_IDENTITY_NAMESPACE, RS_TEXT_CONTROL, RS_IDENTITY_NAMESPACE },
	{ IDC_SERVERLESS_IDP_TOKEN, RS_CHECKBOX_CONTROL, RS_SERVERLESS },
	{ IDC_IDP_WORKGROUP, RS_TEXT_CONTROL, RS_WORKGROUP },
	{ IDC_IDP_MANAGED_VPC, RS_TEXT_CONTROL, RS_VPC_ENDPOINT_URL },
	{ 0, RS_NONE_CONTROL, "" }
};

static int rs_idc_browser_auth_controls[] =
{
	IDC_IDC_REGION_STATIC,
	IDC_IDC_REGION,
	IDC_ISSUER_URL_STATIC,
	IDC_ISSUER_URL,
	IDC_IDENTITY_NAMESPACE_STATIC,
...
static rs_dialog_controls rs_idc_browser_auth_val_controls[] =
{
	...
	{ IDC_ISSUER_URL, RS_TEXT_CONTROL, RS_ISSUER_URL },
	{ IDC_IDENTITY_NAMESPACE, RS_TEXT_CONTROL, RS_IDENTITY_NAMESPACE },
