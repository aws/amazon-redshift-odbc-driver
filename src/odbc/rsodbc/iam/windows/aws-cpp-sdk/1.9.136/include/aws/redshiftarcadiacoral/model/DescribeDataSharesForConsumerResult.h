...
namespace Model
{
  class AWS_REDSHIFTARCADIACORALSERVICE_API DescribeDataSharesForConsumerResult
  {
  public:
    DescribeDataSharesForConsumerResult();
    DescribeDataSharesForConsumerResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DescribeDataSharesForConsumerResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
