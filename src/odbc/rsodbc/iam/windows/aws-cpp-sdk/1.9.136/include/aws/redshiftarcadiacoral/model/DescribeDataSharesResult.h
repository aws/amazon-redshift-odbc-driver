...
namespace Model
{
  class AWS_REDSHIFTARCADIACORALSERVICE_API DescribeDataSharesResult
  {
  public:
    DescribeDataSharesResult();
    DescribeDataSharesResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
    DescribeDataSharesResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
