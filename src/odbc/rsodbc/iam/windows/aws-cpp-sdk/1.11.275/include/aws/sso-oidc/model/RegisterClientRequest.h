...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>This is the Identity Center Issuer URL associated with users Identity Center
     * instance and is used for user access to resources through the client.</p>
     */
    ...
    /**
     * <p>This Identity Center Application ARN is used to define administrator managed
     * configuration for public client access to resources. At authorization, the
     * scopes, grants, and redirect URI available to this client will be restricted by
     * this Application resource.</p>
     */
