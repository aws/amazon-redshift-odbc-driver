...
////////////////////////////////////////////////////////////////////////////////////////////////////
rs_string IAMConfiguration::GetStartUrl() const
{
    return GetSetting(KEY_IDC_START_URL);
}

////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetStartUrl(const rs_string& in_startUrl)
{
    SetSetting(KEY_IDC_START_URL, in_startUrl);
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
short IAMConfiguration::GetIdcResponseTimeout() const
{
    try
    {
        return to_short(GetSetting(KEY_IDC_RESPONSE_TIMEOUT));
    }
    catch (...)
    {
        return 0;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
void IAMConfiguration::SetIdcResponseTimeout(short in_idc_response_timeout)
{
    SetSetting(KEY_IDC_RESPONSE_TIMEOUT, to_rs_string(in_idc_response_timeout));
}
