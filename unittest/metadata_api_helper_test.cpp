...
void TestGetRsType::SetUpTestSuite() {
    ...
    dataTypeMap = {
        ...
        {dataTypeName.kinterval_year_to_month, {SQL_INTERVAL_YEAR_TO_MONTH, SQL_INTERVAL_YEAR_TO_MONTH, SQL_INTERVAL, SQL_CODE_YEAR_TO_MONTH, 13, kNotApplicable, sizeof(SQL_INTERVAL_STRUCT)}},
        {dataTypeName.kinterval_day_to_second, {SQL_INTERVAL_DAY_TO_SECOND, SQL_INTERVAL_DAY_TO_SECOND, SQL_INTERVAL, SQL_CODE_DAY_TO_SECOND, 26, 6, sizeof(SQL_INTERVAL_STRUCT)}},
